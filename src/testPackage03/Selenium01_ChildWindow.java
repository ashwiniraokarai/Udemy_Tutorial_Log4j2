...
public class Selenium01_ChildWindow {

	/*DEMO: Switching between 2 web pages when one has originated from another
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		//Insert APACHE LOG4J2 LOG STATEMENT here:
		logger.info("Launched Google Accounts SignUp Page");
		...
		//Insert APACHE LOG4J2 LOG STATEMENT here:
		logger.debug("Extracting title :{}: of the webpage" ,driver.getTitle()); //Better alternative
		logger.debug("Extracting title: "+driver.getTitle()+ " of the webpage"); //More tedious option
